...
public class CameraPreview extends SurfaceView implements SurfaceHolder.Callback, Runnable {
	...
	private static final String TAG="WebCam1";
...
//        		}
	...
	public void surfaceCreated(SurfaceHolder holder) {
        ...
        new Timer().schedule(new TimerTask() {
			@Override
			public void run() {
				int i = setBrightness(50);
				Log.e(TAG, "run: set brig " + i);
				int j = setContrast(32);
				Log.e(TAG, "run: set cont " + j);
			}
		}, 5000);
	}
